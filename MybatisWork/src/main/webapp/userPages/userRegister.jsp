...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        function  checkdata(uname) {
            ...
            //发送请求
            ajax.open("get","/selectUAjax?uname="+uname);
            ajax.send(null)
            //获取元素对象
        }
...
<body >
<h2 align="center">欢迎新用户注册</h2>
<div align="center">
    <form action="../userReg" method="post" onsubmit=" return checksub()">
        <table align="center">
            <tr>
                <td>用户名</td>
                <td><input type="text" name="uname" value=""id="uname" onblur="checkname()" >
                    <span id="unameSpan">用户名长度为6-16，并且只能由数字和字母组成</span></td>
            </tr>
            <tr>
                <td>真实姓名</td>
