...
<div class="wrap" id="wrap">
    <div class="logGet">
        ...
        <div class="lgD">
            ...
            <a href="adminRegister.jsp"><button class="fanhui">管理员注册</button></a>
            <a href="../userPages/userRegister.jsp"><button class="fanhui">用户注册</button></a>
            <a href="../userPages/userLogin.jsp"><button class="fanhui">用户登陆</button></a>
        </div>
