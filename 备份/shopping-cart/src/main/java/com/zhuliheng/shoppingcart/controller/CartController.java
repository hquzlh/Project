        ...
        if(goodsService.judgeNum(gid))//判断库存是否充足
        {
            ...
            if(user==null){
                ...
                if(cartList!=null){
                    ...
                    Cart cart=new Cart(goods.getGid(),goods.getName(),1,goods.getPrice(),goods.getOne_tag(),goods.getTwo_tag());
                    cartList.add(cart);
                    CookieUtil.addCookie(response,cartList);
                }else {
                ...
                Cart cart=new Cart(user.getUid(),goods.getGid(),goods.getName(),1,goods.getPrice(),goods.getOne_tag(),goods.getTwo_tag());
                cartService.insertCart(cart);
            }
            //判断是否还有库存，true=有
            return "true";
            ...
            if(goodsNumDto.getNum()<=goods.getNum()){
                ...
                if(user==null){
                    ...
                    if(cartList!=null){
                        ...
                        Cart cart=new Cart(null,goods.getGid(),goods.getName(),goodsNumDto.getNum(),goods.getPrice(),goods.getOne_tag(),goods.getTwo_tag());
                        cartList.add(cart);
                        CookieUtil.addCookie(response,cartList);
                        return "redirect:/main.html";
                    }else {
                    ...
                    Cart cart1=new Cart(user.getUid(),goodsNumDto.getGid(),goods.getName(),1,goods.getPrice(),goods.getOne_tag(),goods.getTwo_tag());
                    for (int i = goodsNumDto.getNum(); i>0 ; i--) {
